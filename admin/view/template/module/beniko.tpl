	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo HTTPS_SERVER . 'index.php?route=module/beniko&store_id=' . $store['store_id'] . '&token=' . $this->session->data['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
			...
			<div>
				...
				<div class="bg-tabs">
					...
					<div id="tabs" class="htabs main-tabs">
						...
						<a href="#tab_internal_modules" id="tinternalmodules"><span>Internal modules</span></a>
					...
					<div id="tab_design" class="tab-content2">
						...
						<div id="tab_font" class="tab-content">
							...
							<div class="input">
								...
								<select name="footer_headlines_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($footer_headlines_px==$x || ($x == 22 && $footer_headlines_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
							...
							<div class="input">
								...
								<select name="page_name_weight" style="width:60px;margin-right:20px">
									...
									<?php for( $x = 3; $x <= 6; $x++ ) { ?>
								  <option value="<?php echo $x; ?>" <?php if($page_name_weight==$x || ($x == 4 && $page_name_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
									<?php } ?>
						...
						<div id="tab_colors" class="tab-content">
							...
							<div class="colors_left">
								...
								<div class="color_input">
									<p>Top bar links:</p>
									<div><input type="text" value="<?php echo $top_bar_links; ?>" id="top_bar_links" name="top_bar_links" <?php if($top_bar_links != '') { echo 'style="border-right: 20px solid '.$top_bar_links.'"'; } ?> /></div>
								</div>
							...
							<div class="colors_left">
								...
								<div class="color_input">
									<p>Top text:</p>
									<div><input type="text" value="<?php echo $top_text; ?>" id="top_text" name="top_text" <?php if($top_text != '') { echo 'style="border-right: 20px solid '.$top_text.'"'; } ?> /></div>
								</div>
								
								<!-- Input -->
								<div class="color_input">
									<p>Border elements color:</p>
									<div><input type="text" value="<?php echo $top_border_color; ?>" id="top_border_color" name="top_border_color" <?php if($top_border_color != '') { echo 'style="border-right: 20px solid '.$top_border_color.'"'; } ?> /></div>
								</div>
							...
							<div class="colors_left">
								...
								<!-- Input -->
								<div class="color_input">
									<p>Hover main links:</p>
									<div><input type="text" value="<?php echo $menu_main_hover_links; ?>" id="menu_main_hover_links" name="menu_main_hover_links" <?php if($menu_main_hover_links != '') { echo 'style="border-right: 20px solid '.$menu_main_hover_links.'"'; } ?> /></div>
								</div>
							...
							<div class="colors_left">
								...
								<div class="color_input">
									<p>Color text:</p>
									<div><input type="text" value="<?php echo $button_hover_color_text; ?>" id="button_hover_color_text" name="button_hover_color_text" <?php if($button_hover_color_text != '') { echo 'style="border-right: 20px solid '.$button_hover_color_text.'"'; } ?> /></div>
								</div>
								
								<!-- Input -->
								<div class="color_input">
									<p>Background gradient top:</p>
									<div><input type="text" value="<?php echo $button_hover_background_gradient_top; ?>" id="button_hover_background_gradient_top" name="button_hover_background_gradient_top" <?php if($button_hover_background_gradient_top != '') { echo 'style="border-right: 20px solid '.$button_hover_background_gradient_top.'"'; } ?> /></div>
								</div>
								
								<!-- Input -->
								<div class="color_input">
									<p>Background gradient bottom:</p>
									<div><input type="text" value="<?php echo $button_hover_background_gradient_bottom; ?>" id="button_hover_background_gradient_bottom" name="button_hover_background_gradient_bottom" <?php if($button_hover_background_gradient_bottom != '') { echo 'style="border-right: 20px solid '.$button_hover_background_gradient_bottom.'"'; } ?> /></div>
								</div>
							...
							<div class="colors_left">
								...
								<div class="color_input">
									<p>Icons color:</p>
									<div><input type="text" value="<?php echo $footer_icons_color; ?>" id="footer_icons_color" name="footer_icons_color" <?php if($footer_icons_color != '') { echo 'style="border-right: 20px solid '.$footer_icons_color.'"'; } ?> /></div>
								</div>
							...
							<div class="colors_left">
								...
								<!-- Input -->
								<div class="color_input">
									<p>Hover product border color:</p>
									<div><input type="text" value="<?php echo $hover_product_border_color; ?>" id="hover_product_border_color" name="hover_product_border_color" <?php if($hover_product_border_color != '') { echo 'style="border-right: 20px solid '.$hover_product_border_color.'"'; } ?> /></div>
								</div>
								
								<!-- Input -->
								<div class="color_input">
									<p>Inputs focus border color:</p>
									<div><input type="text" value="<?php echo $inputs_focus_border_color; ?>" id="inputs_focus_border_color" name="inputs_focus_border_color" <?php if($inputs_focus_border_color != '') { echo 'style="border-right: 20px solid '.$inputs_focus_border_color.'"'; } ?> /></div>
								</div>
					...
					<div id="tab_internal_modules" class="tab-content3">
					
						<div class="footer_left" style="margin-top: 199px">
						
							<!-- Contact, About us, Facebook TABS -->
							
							<div id="tabs_internal_modules" class="htabs main-tabs">
								
								<?php foreach ($languages as $language): ?>
								<a href="#tab_internal_module_<?php echo $language['language_id']; ?>"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /><span><?php echo $language['name']; ?></span></a>
								<?php endforeach; ?>
						...
						<div class="footer_right">
							...
							<div id="tab_internal_module_<?php echo $language_id; ?>">
							
								<!-- Contact, About us, Facebook TABS -->
								
								<div id="tabs_<?php echo $language_id; ?>" class="htabs tabs-design">
								
									<a href="javascript: void();" class="ttop selected"><span>Top</span></a>
								...
								<div id="tab_internal_modules_top_<?php echo $language_id; ?>" class="tab-content4">
								
									<!-- Status -->
									
									<?php if(isset($internal_modules_top[$language_id]['status'])) { ?>
									<?php if($internal_modules_top[$language_id]['status'] == 1) { echo '<div class="status status-on" title="1" rel="internal_modules_top_'.$language_id.'_status"></div>'; } else { echo '<div class="status status-off" title="0" rel="internal_modules_top_'.$language_id.'_status"></div>'; } ?>
									
									<input name="internal_modules_top[<?php echo $language_id; ?>][status]" value="<?php echo $internal_modules_top[$language_id]['status']; ?>" id="internal_modules_top_<?php echo $language_id; ?>_status" type="hidden" />
									<?php } else { ?>
									<?php echo '<div class="status status-off" title="0" rel="internal_modules_top_'.$language_id.'_status"></div>'; ?>
									<input name="internal_modules_top[<?php echo $language_id; ?>][status]" value="0" id="internal_modules_top_<?php echo $language_id; ?>_status" type="hidden" />
									<?php } ?>
									
									<h4>Information module</h4>
									...
									<div class="input">										
										...
										<p>Text:</p>
										<?php if(isset($internal_modules_top[$language_id]['text'])) { ?>
										<textarea rows="0" cols="0" name="internal_modules_top[<?php echo $language_id; ?>][text]"><?php echo $internal_modules_top[$language_id]['text']; ?></textarea>
										<?php } else { ?>
										<textarea rows="0" cols="0" name="internal_modules_top[<?php echo $language_id; ?>][text]"></textarea>
										<?php } ?>
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input">
							<p style="width:240px">Custom module (banners, contact us):</p>
...
$(document).ready(function(){ 
	...
	$('#tabs_internal_modules a').tabs();
	if($.cookie('tabs_internal_modules_cookie') > 0) {
		$('#tabs_internal_modules a').eq($.cookie('tabs_internal_modules_cookie')).trigger("click");
	}
	$('#tabs_internal_modules a').click(function() {
		var element_index = $('#tabs_internal_modules a').index(this);
		$.cookie('tabs_internal_modules_cookie', element_index); 
	});
