...
<!-- BREADCRUMB
	================================================== -->
<div class="breadcrumb <?php if($this->theme_options->get( 'breadcrumb_layout' ) == 2) { echo 'fixed'; } else { echo 'full-width'; } ?>">
...
<!-- MAIN CONTENT
	================================================== -->
<div class="main-content <?php if($this->theme_options->get( 'content_layout' ) == 2) { echo 'fixed'; } else { echo 'full-width'; } ?> inner-page">
  			...
  			<div class="row">
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     <div class="description">
			     	<h2 id="title-page" itemprop="name"><?php echo $heading_title; ?></h2>
			     </div>
